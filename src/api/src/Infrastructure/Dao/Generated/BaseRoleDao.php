...
/**
 * The BaseRoleDao class will maintain the persistence of Role class into the roles
 * table.
 */
abstract class BaseRoleDao
{
     ...
     */
    public function save(\App\Domain\Model\Role $obj) : void
    {
     ...
     *
     * @return \App\Domain\Model\Role[]|\TheCodingMachine\TDBM\ResultIterator
     */
     ...
     */
    public function getById(string $id, bool $lazyLoading = false) : \App\Domain\Model\Role
    {
     ...
     * Get all Role records.
     *
     * @param \App\Domain\Model\Role $obj The object to delete
     * @param bool $cascade If true, it will delete all objects linked to $obj
     */
    public function delete(\App\Domain\Model\Role $obj, bool $cascade = false) : void
    {
        if ($cascade === true) {
     ...
     * @param mixed[] $parameters The parameters associated with the filter
     * @param string[] $additionalTablesFetch A list of additional tables to fetch (for performance improvement)
     * @return \App\Domain\Model\Role|null
     */
    protected function findOne($filter = null, array $parameters = [], array $additionalTablesFetch = []) : ?\App\Domain\Model\Role
    {
     ...
     * @return \App\Domain\Model\Role|null
     */
    protected function findOneFromSql(string $from, $filter = null, array $parameters = []) : ?\App\Domain\Model\Role
    {
    ...
    /**
     * Get a Role filtered by code.
     *
     * @param string $code
     * @param string[] $additionalTablesFetch A list of additional tables to fetch (for performance improvement)
     * @return \App\Domain\Model\Role|null
     */
    public function findOneByCode(string $code, array $additionalTablesFetch = []) : ?\App\Domain\Model\Role
    {
        $filter = [
                    'code' => $code,
                ];
