...
it(
    ...
    function (string $search): void {
        ...
        $result = $searchCompanies->search($search);
...
it(
    ...
    function (string $sortOrder): void {
        ...
        $result = $searchCompanies->search(null, CompaniesSortByEnum::NAME, $sortOrder);
        assertCount(3, $result);
...
it(
    ...
    function (string $sortOrder): void {
        ...
        $result = $searchCompanies->search(null, CompaniesSortByEnum::WEBSITE, $sortOrder);
        assertCount(3, $result);
...
it(
    ...
    function (string $sortBy, string $sortOrder): void {
        ...
        $searchCompanies->search(null, $sortBy, $sortOrder);
    }
)
    ->with([
        // Invalid sort by.
